...
static bool try_fill_buffer(Conn *conn) {
  ...
  // Loop do to pipeling where write/read requests are batched
...
int main() {
  log("Server.Main", "Starting Server");
  ...
  log("Server.Main", "Created Socket w Options");
  ...
  log("Server.Main", "Bound to socket");
  ...
  log("Server.Main", "Listening to Socket");
